...
export const PROPOSAL_ACCESS_COOKIE = 'alpath_union_street_cre_access';
export const PROPOSAL_ACCESS_MAX_AGE = 60 * 60 * 24 * 90;

const PROPOSAL_PASSWORD =
  process.env.UNION_STREET_CRE_PROPOSAL_PASSWORD || 'applepie';

const digest = (value) => createHash('sha256').update(String(value)).digest();

const accessToken = createHash('sha256')
  .update(`alpath-union-street-cre:${PROPOSAL_PASSWORD}`)
  .digest('hex');
