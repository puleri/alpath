...
const UNLOCK_ENDPOINT = '/RFQ/sumner-wa/unlock';
...
export default function ProposalPasswordGate() {
  ...
  const submitPassword = async (event) => {
    ...
    if (!password) {
      setError('Enter the statement password to continue.');
      return;
    }
    ...
    try {
      ...
      setError('We could not unlock the statement. Please try again.');
      setPhase('idle');
    }
  };
  ...
  return (
    ...
    >
      ...
      >
        ...
        <p className={styles.passwordGateEyebrow}>
          Private statement of qualifications
        </p>
        <h1 id="proposal-access-heading">City of Sumner</h1>
        ...
        >
          <label htmlFor="proposal-password">Statement password</label>
          <div className={styles.passwordControl}>
            ...
            <button disabled={isBusy} type="submit">
              {isBusy ? 'Unlocking...' : 'Unlock statement'}
            </button>
          </div>
        ...
        <p className={styles.passwordGateNote}>
          Please reach out to matt@alpathengineering.com if you need a new
          password.
        </p>
      </section>
    </main>
