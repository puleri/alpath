...
export const PROPOSAL_ACCESS_COOKIE = 'alpath_snohomish_fd4_access';
export const PROPOSAL_ACCESS_MAX_AGE = 60 * 60 * 24 * 90;

const PROPOSAL_PASSWORD =
  process.env.SNOHOMISH_FD4_PROPOSAL_PASSWORD || 'rhubarbpie';

const digest = (value) => createHash('sha256').update(String(value)).digest();

const accessToken = createHash('sha256')
  .update(`alpath-snohomish-fd4:${PROPOSAL_PASSWORD}`)
  .digest('hex');
